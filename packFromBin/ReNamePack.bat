...
REM 删除Bat下旧文件
set "targetFileName64=NumDesToolsFunPack64.xll"  
set "targetFileName32=NumDesToolsFunPack.xll"  
...
REM 复制bin下新文件
set "sourceFileName64=NumDesToolsFun-AddIn64-packed.xll"   
set "sourceFileName32=NumDesToolsFun-AddIn-packed.xll"   

set "sourceFile64=\bin\Release\net9.0-windows\publish\%sourceFileName64%" 
set "sourceFile32=\bin\Release\net9.0-windows\publish\%sourceFileName32%"   
